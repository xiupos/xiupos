...
何も考えず行列を直接扱うことができるので, かなり書きやすいと感じた. ただ, 動的型付けなのもあり, よく考えて書かないと行列の積などでサイズが合わず苦労する. まあそれは Julia に限った話ではない. むしろ, 前述の数式をかなりそのままコードにすることができ, それが Julia の良さなのだろう[^unicode].

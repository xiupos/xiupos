...
$$
ただし $\/∂≡γ^μ∂_μ$ は Dirac 演算子, $γ^μ∂_μ$ $γ^μ$ は $\{γ^μ,γ^ν\}=g^{μν}$ を満たす $γ$ 行列で, $\overline{ψ}≡ψγ^0$ は Dirac 共役である. また, Dirac 場 $ψ$ は成分を複数持つ列ベクトルで, 例えば4成分である. ここで, $ψ$ と $\overline{ψ}$ を独立に扱って,
$$
\begin{gathered}

...
4. 微小変換 $g(x)↦g'(x)=g(x)+δg(x)$ に対し $φ(g(x))↦φ'(g'(x))=φ(g(x))+δφ(g(x))$ と変換されるとき, 汎関数 $F_{g'(x)}[φ']$ を 1 次まで展開することを考える. 汎関数 $F_{g(x)}[φ']$ をパラメータ $g(x)$ に関する汎関数 (つまり $G_x[g,φ']:=F_{g(x)}[φ']$) と見れば $δg(x)$ の 1次で展開することができ,
    $$
    F_{g'(x)}[φ'] = F_{g(x)+δg(x)}[φ'] = F_{g(x)}[φ'] + ∫\d{y} \fdv{F_{g(x)}[φ']}{g(y)} δg(y).
    $$
    ただし, $δ^Lφ(g(x))$ は Lie 微分である:
    $$
    δ^Lφ(g(x)) := φ'(g(x)) - φ(g(x)) = δφ(g(x)) - \dv{φ(g(x))}{g(x)} δg(x).
    $$
    次に $F_{g(x)}[φ']$ を 1 次で展開して,
    $$
    \begin{aligned}
      F_{g(x)}[φ']
        &= F_{g(x)}[φ+δ^Lφ] \\
        &= F_{g(x)}[φ] + ∫\d{g(y)} \fdv{F_{g(x)}[φ]}{φ(g(y))} δ^Lφ(g(y)) \\
        &= F_{g(x)}[φ] + ∫\d{g(y)} \fdv{F_{g(x)}[φ]}{φ(g(y))} δφ(g(y)) - ∫\d{g(y)} \fdv{F_{g(x)}[φ]}{φ(g(y))} \dv{φ(g(y))}{g(y)} δg(y) \\
        &= F_{g(x)}[φ] + ∫\d{g(y)} \fdv{F_{g(x)}[φ]}{φ(g(y))} δφ(g(y)) - ∫\d{y} \fdv{F_{g(x)}[φ]}{φ(g(y))} \dv{φ(g(y))}{y} δg(y). \\
    \end{aligned}
    $$
    これを前の式に代入すれば, $F_{g'(x)}[φ']$ の 1 次の展開が得られる:
    $$
    \begin{aligned}
      F_{g'(x)}[φ']
        &= F_{g(x)}[φ] + ∫\d{g(y)} \fdv{F_{g(x)}[φ]}{φ(g(y))} δ^Lφ(g(y)) + ∫\d{y} \fdv{F_{g(x)}[φ]}{g(y)} δg(y) \\
        &= F_{g(x)}[φ] + ∫\d{g(y)} \fdv{F_{g(x)}[φ]}{φ(g(y))} δφ(g(y)) + ∫\d{y} \bqty{\fdv{F_{g(x)}[φ]}{g(y)} - \fdv{F_{g(x)}[φ]}{φ(g(y))} \dv{φ(g(y))}{y}} δg(y). \\
    \end{aligned}
    $$

...
4. 微小変換 $x(t)↦x'(t)=x(t)+δx(t)$ に対し $φ(x(t))↦φ'(x'(t))=φ(x(t))+δφ(x(t))$ と変換されるとき, 汎関数 $F_{x'(t)}[φ']$ を 1 次まで展開することを考える. 汎関数 $F_{x(t)}[φ']$ をパラメータ $x(t)$ に関する汎関数 (つまり $G_t[x,φ']:=F_{x(t)}[φ']$) と見れば $δx(t)$ の 1次で展開することができ,
    $$
    \begin{aligned}
      F_{x'(t)}[φ']
        &= F_{x(t)+δx(t)}[φ'] \\
        &= F_{x(t)}\bqty{φ'+δx\dv{φ'}{x}} + ∫\d{t_0} \fdv{F_{x(t)}\bqty{φ'+δx\dv{φ'}{x}}}{x(t_0)} δx(t_0) \\
        &= F_{x(t)}\bqty{φ'} + ∫\d{x(t_0)} \fdv{F_{x(t)}[φ']}{φ'(x(t_0))} \dv{φ'(x(t_0))}{x(t_0)} δx(t_0) + ∫\d{t_0} \fdv{F_{x(t)}\bqty{φ'+δx\dv{φ'}{x}}}{x(t_0)} δx(t_0) \\
        &= F_{x(t)}\bqty{φ+δ^Lφ} + ∫\d{t_0} \fdv{F_{x(t)}[φ]}{φ(x(t_0))} \dv{φ(x(t_0))}{t_0} δx(t_0) + ∫\d{t_0} \fdv{F_{x(t)}\bqty{φ}}{x(t_0)} δx(t_0).
    \end{aligned}
    $$
    ...
    \begin{aligned}
      F_{x'(t)}[φ']
        &= F_{x(t)}[φ] + ∫\d{x(t_0)} \fdv{F_{x(t)}[φ]}{φ(x(t_0))} δ^Lφ(x(t_0)) + ∫\d{t_0} \bqty{\fdv{F_{x(t)}[φ]}{x(t_0)} + \fdv{F_{x(t)}[φ]}{φ(x(t_0))} \dv{φ(x(t_0))}{t_0}} δx(t_0) \\
        &= F_{x(t)}[φ] + ∫\d{x(t_0)} \fdv{F_{x(t)}[φ]}{φ(x(t_0))} δφ(x(t_0)) + ∫\d{t_0} \fdv{F_{x(t)}[φ]}{x(t_0)} δx(t_0). \\
    \end{aligned}
    $$

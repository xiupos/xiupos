...
\end{aligned}
$$
これは状態 $|ψ(t)⟩$ の時間発展を表した方程式であり, **Schrödinger 方程式**という. または左から $⟨q,t|$ を内積させて, 波動関数に関する Schrödinger 方程式が得られる:
$$
...
$$
\^q_i ψ(q,t) = ⟨q,t| \^q_i |ψ(t)⟩ = q_i ⟨q,t ∣ ψ(t)⟩ = q_i ψ(q,t).
$$
...
$$
$$
∴ \^p^i ψ(q,t) = ⟨q,t| \^p^i |ψ(t)⟩ = - iℏ \pdv{}{q_i} ψ(q,t).
$$

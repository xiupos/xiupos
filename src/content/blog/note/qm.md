...
$$
反対に, 古典場 $ψ(\bm{x},t)$ が満たす Euler-Lagrange 方程式に対し, その場を量子化して得られる演算子 $\^ψ(\bm{x},t)$ によって得られる1粒子状態の波動関数 $Ψ(\bm{x},t) = ⟨\bm{x},t∣Ψ⟩ = ⟨0|\^ψ(\bm{x},t)|Ψ⟩$ は, Euler-Lagrange 方程式のうちの1つと同じ形の Schrödinger 方程式を満たす.
